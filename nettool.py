...
def usage ():
    ...
    print
    print "Examples: "
    print "nettool.py -t 192.168.0.1 -p 5555 -l -c"
    print "nettool.py -t 192.168.0.1 -p 5555 -l -u=C:\\target.exe"
    print "nettool.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\""
    print "echo 'ABCDEFGHI' | ./nettool.py -t 192.168.11.12 -p 135"
    sys.exit(0)
